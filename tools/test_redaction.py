...
LEAKS = {
    ...
    "storage_account":   'account is st08061641examplelake here',
    "systemd_unit":      'systemctl restart orcasound-bush-audio.service',
    ...
    "guid":              'SUB=cad44ef1-313a-4da8-8d66-a58b6467472e',
    "operator_home":     'ls /Users/somebody/wildlife-runs',
    "private_ip":        'INTERNAL=10.1.2.3',
    "public_ip":         'ssh bridge@40.65.95.39',
